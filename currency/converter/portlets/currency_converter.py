...
#    def __init__(self, default_base_currency="EUR"):
...
class Renderer(base.Renderer, CurrencyManagerView):
...
#def CurrencyCodeNameVocabularyFactory(context):
#    """Vocabulary factory for currencies."""
##    items = [(i[0], i[1][0]) for i in currencies.items()]
##    return SimpleVocabulary.fromItems(items)
#    return [(i[0], i[1][0]) for i in currencies.items()]
#directlyProvides(CurrencyCodeNameVocabularyFactory, IVocabularyFactory)
